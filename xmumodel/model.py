...
class Model(object, metaclass=ABCMeta):
    def __init__(self, num_layers=32, feature_size=256, scale=8, input_channels=3, output_channels=3, prunedlist = [0]*19):
        ...
        self.target = tf.placeholder(tf.float32, [None, None, None, output_channels], name='target')
